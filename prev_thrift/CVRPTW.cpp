...
CVRPTW_ping_args::~CVRPTW_ping_args() throw() {
}


uint32_t CVRPTW_ping_args::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t CVRPTW_ping_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("CVRPTW_ping_args");
...
CVRPTW_ping_pargs::~CVRPTW_ping_pargs() throw() {
}


uint32_t CVRPTW_ping_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("CVRPTW_ping_pargs");
...
CVRPTW_ping_result::~CVRPTW_ping_result() throw() {
}


uint32_t CVRPTW_ping_result::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t CVRPTW_ping_result::write(::apache::thrift::protocol::TProtocol* oprot) const {

  uint32_t xfer = 0;

  xfer += oprot->writeStructBegin("CVRPTW_ping_result");
...
CVRPTW_ping_presult::~CVRPTW_ping_presult() throw() {
}


uint32_t CVRPTW_ping_presult::read(::apache::thrift::protocol::TProtocol* iprot) {
...
void CVRPTWClient::ping(std::string& _return)
{
  send_ping();
  recv_ping(_return);
}

void CVRPTWClient::send_ping()
{
  int32_t cseqid = 0;
  oprot_->writeMessageBegin("ping", ::apache::thrift::protocol::T_CALL, cseqid);

  CVRPTW_ping_pargs args;
  args.write(oprot_);
...
void CVRPTWClient::recv_ping(std::string& _return)
{
...
void CVRPTWProcessor::process_ping(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("CVRPTW.ping", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "CVRPTW.ping");

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preRead(ctx, "CVRPTW.ping");
  }

  CVRPTW_ping_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postRead(ctx, "CVRPTW.ping", bytes);
  }

  CVRPTW_ping_result result;
  try {
    iface_->ping(result.success);
    result.__isset.success = true;
  } catch (const std::exception& e) {
    if (this->eventHandler_.get() != NULL) {
      this->eventHandler_->handlerError(ctx, "CVRPTW.ping");
    }
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preWrite(ctx, "CVRPTW.ping");
  }
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postWrite(ctx, "CVRPTW.ping", bytes);
  }
}
...
void CVRPTWConcurrentClient::ping(std::string& _return)
{
  int32_t seqid = send_ping();
  recv_ping(_return, seqid);
}

int32_t CVRPTWConcurrentClient::send_ping()
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("ping", ::apache::thrift::protocol::T_CALL, cseqid);
...
void CVRPTWConcurrentClient::recv_ping(std::string& _return, const int32_t seqid)
{
